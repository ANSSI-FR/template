...
La stratégie open source de l'ANSSI identifie trois catégories de projets publiés sur le dépôt de code de l'ANSSI :

- les **projets doctrinaux diffusant des éléments de doctrine de l'Agence ou en accompagner la publication** :
...
Comme l'explicite le document de stratégie open source de l'ANSSI, cette [classification s'appuie sur celle élaborée par la DINUM](https://guides.data.gouv.fr/autres-ressources-utiles/codes-sources-du-secteur-public-lesquels-ouvrir-pourquoi-et-comment) :
